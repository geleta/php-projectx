...
<?php
$update=$_GET['update'];
$result = mysqli_query($mysqli,"SELECT * FROM customer where Cust_Id ='$update'");
?>
<?php if($row = mysqli_fetch_array($result))
  {?> 
   ...
   <td>
		<input type="hidden" name="ID" id="ID" value="<?php echo $row['Cust_Id'];?>"  placeholder="" required>
   ...
   <tr>
    <td>  
	  ...
	  <label>Full Name:</label>
		...
		<input type="text" name="name" id="name"  value="<?php echo $row['FullName'];?>"  placeholder="Full name" required>
		<span class="error">This is an error</span>
	</td>
   <td>   
    ...
    <td>  
		...
		<input type="text" id="phone" name="phone" value="<?php echo $row['Phone'];?>" placeholder="0925922030" required>
	...
	<td>  
		...
		<input type="text" id="email" name="email" value="<?php echo $row['Email'];?>" placeholder="geletabegna@gmail.com" >
		<span id="pass-info"> </span>
	...
	<td>  
		...
		<input type="password" id="Rpassword" name="Rpassword" value="<?php echo $row['Re_Password'];?>" placeholder="*******" required>
		<span id="pass-info"> </span>
                               
	</td>
		<td>
	<label>Country:</label>
		<select name="select" id="select" value="<?php echo $row['Country'];?>">
	...
	<td>  
		...
		<input type="text" id="city" name="city" value="<?php echo $row['City'];?>" placeholder="Robe" required>
		<span id="pass-info"> </span>
...
<td>  
		...
		<input type="text" id="adress" name="adress" value="<?php echo $row['Adress'];?>" placeholder="MWU" required>
		<span id="pass-info"> </span>
	...
	<td>  
		...
		<input type="text" id="post" name="post" value="<?php echo $row['PostalCode'];?>" placeholder="247" >
		<span id="pass-info"> </span>
   ...
   <tr>
						...
						<button type="submit"  name="submit" id="submit" value="Update" class="a-btn"> <span class="a-btn-text">Update Customer</span></button>
