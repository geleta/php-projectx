  ...
  {?> 
	...
	<form class="quick_search">
		 ...
		 <table>
					...
					<th colspan="3"><h2>Update Warehouse:</h2> </th> 
    ...
    <td>  
		...
		<input type="text" name="Warehouse" id="wname"  value="<?php echo $row['Warehouse'];?>"  placeholder="Warehouse Name" required>
   ...
   <td>  
	...
	<label>Country:</label>
		<select name="select" id="select"  value="<?php echo $row['Country'];?>"  placeholder="Select Country" required>
		  ...
		  <option value="SOM" countrynum="252">Ethiopia</option>
