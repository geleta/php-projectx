...
<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_tags"><a href="add_warehouse.php">Manage Warehouse</a></li> 
			<li class="icn_tags"><a href="add_customer.php">Manage Customer</a></li> 
	...
	<section id="main" class="column">
		...
		<?php
$result = mysqli_query($mysqli,"SELECT * FROM payments");
?>
      			<div id="tab2" class="tab_content">

  <table class="tablesorter" cellspacing="0"> 
      <thead>
			<thead><th colspan="15"> Customer Payment Detail </th></thead>
		<thead>
			</tr>
   		    <th>Check</th> 
			<th> ID</th>
