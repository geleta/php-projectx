...
$w=array(20,40,20,27,34,33,20,27,18,15,15,15,15);
	...
	{ //width
		...
		$this->Cell(20,6,$eachResult["quantity"],1);
...
$header=array('Product ID','Product Name','Category ID','Model','Type','Warehouse_ID','Price','Quantity');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->AddPage();
	...
	$pdf->Cell(55);
	$pdf->Write(5, ' DOYA STORE PRODUCT DATA REPORT ');
	$pdf->Ln();
	
	$pdf->SetFont('Helvetica','b',12);
	$pdf->Cell(75);
	$pdf->Write(3, 'PRODUCT REPORT');
	$pdf->Ln();
