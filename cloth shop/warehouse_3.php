	...
	<div id="wrapper">
	  ...
	  <div id="header">
			<!-- Begin Shell -->
				...
				<h1><a class="notext" href="#" title="doya"><img src="images/dress1.jpg" width="1200" height="110">Doyacart</a>
...
?>
 ...
 <div class="clear"></div>
	...
	$results = $mysqli->query("SELECT * FROM product where Warehouse_ID IN (9,15) ORDER BY Product_ID ASC");
    if ($results) { 
