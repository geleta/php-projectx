...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="Doyashop">Doyashop</a></h1>
				<div id="top-nav">
					<ul>
...
?>
                            ...
                            <p>
                                ...
                                <input id="email" name="email" placeholder="geletabegna@gmail.com" type="email" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
...
?>
                           ...
                           <p>
                                ...
                                <input id="address" name="address" placeholder="e.g. kebele 01" type="text" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
		  ...
		  <option value="ZW" countrynum="263">Zimbabwe</option>
							...
							<p> 
                                ...
                                <input id="phone" name="phone" placeholder="e.g. +251-925922030" type="tel" AUTOCOMPLETE=OFF />
                            </p>
...
?>
							...
							<p>
								Remember Sir If You Proceed it Now You Can Find Your Sales Voucher Or Payment Voucher In Your Mail Box In A few Minutes.
							</p>
                            <p class="submit">
