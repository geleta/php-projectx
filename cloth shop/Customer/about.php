...
<!-- Begin Sidebar -->
		...
		<!-- End Main -->
			...
			<div class="copy">
				<!-- Begin Shell -->
				<div class="shell">
					<div class="carts"></div>	<p align="center">&copy; doyashop.com. Groups <a href="home.php"><i><font color="fefefe"> Welcome To <strong> doyashop</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
