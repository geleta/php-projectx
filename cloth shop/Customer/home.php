	...
	<div id="wrapper">
		...
		<div id="header">
			...
			<div class="shell">
			  <div id="top-nav">
				  <ul>
						<li><a href="#" title="User Name"> <span class="gale"><?php echo "Welcome as: ". "<i><b>".$login_session."</b></i>" ;?></span></a></li>
...
if(isset($_SESSION["cart_session"]))
{
    ...
    echo '</ul>';
    echo '<span class="check-out-txt"><strong style="color:green" ><i>Total:</i> <big style="color:green" >'.$currency.$total.'</big></strong> <a   class="a-btngale"  href="view_cart.php"> <span class="a-btn-text" align><big>Check Out</big></span></a></span>';
...
<!-- Begin Slider -->
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
						<h2>Welcome!</h2>
					<img src="images/logo.jpg" alt="Post Image" height="75" width="186"/>
    ...
    ?>
			...
			<!-- Begin Products Slider --><!-- End Products Slider -->
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About Balestore</h2>
						<div class="box-entry">
							<img src="images/logo.jpg" alt="Balestore" width="160" height="80"/>
							<p>You can be confident when you're shopping online with Balestore. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="Paypal"><img src="images/paypal_button.png" width="70" height="30" alt="Paypal" /></a></li>
							</ul>
					</div>	<p>&copy; DoyaShop.com. Groups <a href="home.php"><i><font color="fefefe"> Welcome To DoyaShop Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
