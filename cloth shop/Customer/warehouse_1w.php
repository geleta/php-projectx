...
?>
 ...
 <div class="clear"></div>
	...
	$results = $mysqli->query("SELECT * FROM product where Warehouse_ID=11 ORDER BY Product_ID ASC");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
           ...
           echo 'Qty <input type="number" name="product_qty" value="1" min="1" max='.$obj->quantity.' size="3" />';
			...
			/* echo '<div class="button"><span><button onclick="myFunction()"><img src="images/cart.jpg align="left" alt="" />Add to cart</button>
<script>
function myFunction() {
		...
		<div id="footer">
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						...
						<div class="box-entry">
							<img src="images/logo.png" alt="DoyaShop" width="160" height="80"/>
			...
			<div class="copy">
				...
				<div class="shell" align="center">
					<div class="carts">
					</div>	<p>&copy; DoyaShop. Groups <a href="home.php"><i><font color="fefefe"> Welcome To DoyaShop Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
