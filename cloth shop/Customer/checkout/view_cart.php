...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
          ...
          while($obj = $results->fetch_object())
        {
            ...
            echo '<td class="p-qty">Qty :<input type="text" name="product_qty" value="'.$cart_itm["ProductItem"].'" size="2"   maxlength="5" /></td>';
		...
		echo '<span class="midigta"> <a  class="a-btn" href="checkout/paypal.php" width="100"> <span class="a-btn-text"> <img src="paypal_button.png" width="100" height="60"></span></a></span>';
		echo '</span>';
		echo '</form>'; 
