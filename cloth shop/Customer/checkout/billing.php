...
$w=array(50,70,40,85,30,20,20,20,18,15,15,15,15);
	...
	{ //width
		$this->Cell(50,6,$eachResult["order_ID"],1);
		$this->Cell(70,6,$eachResult["Full_Name"],1);
		$this->Cell(40,6,$eachResult["Delivery_time"],1);
...
$header=array('order ID','Full Name','Delivery Time');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->AddPage();
	...
	$result=mysqli_query($mysqli,"Select * from orders") or die ("Database query failed: $query" . mysqli_error());
