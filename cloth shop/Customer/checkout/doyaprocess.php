...
<select name="time" id="time"  title="Please Select Time">
...
<label>Delivery Date</label>
 ...
 <select name="ddate" id="ddate"   title="Please Select Time">
<option selected=selected></option>
...
if (x==null || x=="")
    {
    alert("You must Choose DELIVERY TIME");
    return false;
    }
...
if (x==null || x=="")
    {
    alert("You must Choose DELIVERY DAY");
    return false;
    }
